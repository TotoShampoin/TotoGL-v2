...
PlaneGeometry::PlaneGeometry(const float& width, const float& height):
    Geometry({
        {{-width / 2, -height / 2, 0}, {0, 0, 1}, {0, 0}, {1, 1, 1}},
        {{width / 2, -height / 2, 0}, {0, 0, 1}, {1, 0}, {1, 1, 1}},
        {{width / 2, height / 2, 0}, {0, 0, 1}, {1, 1}, {1, 1, 1}},
        {{-width / 2, height / 2, 0}, {0, 0, 1}, {0, 1}, {1, 1, 1}}
    }, {
        {0, 1, 2},
        {2, 3, 0}
    })
...
BoxGeometry::BoxGeometry(const float& width, const float& height, const float& depth):
    Geometry({
        {{-width / 2, -height / 2, depth / 2}, {0, 0, 1}, {0, 0}, {1, 1, 1}},
        {{width / 2, -height / 2, depth / 2}, {0, 0, 1}, {1, 0}, {1, 1, 1}},
        {{width / 2, height / 2, depth / 2}, {0, 0, 1}, {1, 1}, {1, 1, 1}},
        {{-width / 2, height / 2, depth / 2}, {0, 0, 1}, {0, 1}, {1, 1, 1}},
        {{width / 2, -height / 2, depth / 2}, {1, 0, 0}, {0, 0}, {1, 1, 1}},
        {{width / 2, -height / 2, -depth / 2}, {1, 0, 0}, {1, 0}, {1, 1, 1}},
        {{width / 2, height / 2, -depth / 2}, {1, 0, 0}, {1, 1}, {1, 1, 1}},
        {{width / 2, height / 2, depth / 2}, {1, 0, 0}, {0, 1}, {1, 1, 1}},
        {{width / 2, -height / 2, -depth / 2}, {0, 0, -1}, {0, 0}, {1, 1, 1}},
        {{-width / 2, -height / 2, -depth / 2}, {0, 0, -1}, {1, 0}, {1, 1, 1}},
        {{-width / 2, height / 2, -depth / 2}, {0, 0, -1}, {1, 1}, {1, 1, 1}},
        {{width / 2, height / 2, -depth / 2}, {0, 0, -1}, {0, 1}, {1, 1, 1}},
        ...
        {{-width / 2, height / 2, depth / 2}, {-1, 0, 0}, {1, 1}, {1, 1, 1}},
        {{-width / 2, height / 2, -depth / 2}, {-1, 0, 0}, {0, 1}, {1, 1, 1}},
        {{-width / 2, height / 2, depth / 2}, {0, 1, 0}, {0, 0}, {1, 1, 1}},
        {{width / 2, height / 2, depth / 2}, {0, 1, 0}, {1, 0}, {1, 1, 1}},
        {{width / 2, height / 2, -depth / 2}, {0, 1, 0}, {1, 1}, {1, 1, 1}},
        {{-width / 2, height / 2, -depth / 2}, {0, 1, 0}, {0, 1}, {1, 1, 1}},
        {{-width / 2, -height / 2, -depth / 2}, {0, -1, 0}, {0, 0}, {1, 1, 1}},
        {{width / 2, -height / 2, -depth / 2}, {0, -1, 0}, {1, 0}, {1, 1, 1}},
        {{width / 2, -height / 2, depth / 2}, {0, -1, 0}, {1, 1}, {1, 1, 1}},
        {{-width / 2, -height / 2, depth / 2}, {0, -1, 0}, {0, 1}, {1, 1, 1}}
...
SphereGeometry::SphereGeometry(const float& radius, const int& width_segments, const int& height_segments) {
    for (int y = 0; y <= height_segments; ++y) {
        for (int x = 0; x <= width_segments; ++x) {
            ...
            float xPos = radius * glm::cos(xSegment * 2.0f * PI) * glm::sin(ySegment * PI);
            float yPos = radius * glm::cos(ySegment * PI);
            float zPos = radius * glm::sin(xSegment * 2.0f * PI) * glm::sin(ySegment * PI);
    ...
    if (!open_ended) {
        ...
        for (int x = 0; x <= radial_segments; ++x) {
            ...
            vertices().push_back({
                {xPos, yPos, zPos},
                {0, 1, 0},
                {(xPos / radius_top) / 2.0f + 0.5f, (zPos / radius_top) / 2.0f + 0.5f},
                {1.0f, 1.0f, 1.0f}
            });

            if (x < radial_segments) {
                triangles().push_back({baseIndex, baseIndex + x + 1, baseIndex + x + 2});
